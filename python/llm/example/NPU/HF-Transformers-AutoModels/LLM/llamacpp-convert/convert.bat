set GGUF_PATH="D:\yina\BigDL\yina-model-weights\ggml-model-llama3.2b-instruct-pure-q4_0.gguf"
...
build\Release\convert-gguf-to-npu.exe -m %GGUF_PATH% -o D:\yina\BigDL\python\llm\example\NPU\HF-Transformers-AutoModels\LLM\CPP_Examples\llama3.2-3b-q40 --low-bit asym_int4